...
//информацию в переменных типа long long. В качестве результата программа должна
//отображать процентное соотношение численности населения США (или выбранной
//страны) и все мира. Результат выполнения программы должен выглядеть следующим
//образом:
...
int main() {
    ...
    // Расчет процентного соотношения численности населения
