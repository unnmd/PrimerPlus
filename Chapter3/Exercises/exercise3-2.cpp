...
// расчитать BMI, сначала преобразуйте рост в футах и дюймах в рост дюймах (1
...
// 2.2. После расчитайте BMI, разделив массу в килограммах на квадрат роста в
// метрах. Для представления различных коэффинцентов преобразования используйте
